...
export default function CustomCursor() {
  ...
  // Adjust cursor size via variants
  const variants = {
    default: {
      width: 32,
      height: 32,
    ...
    hover: {
      ...
      x: hoverText ? useSpring(useMotionValue(cursorX.get() - 24), springConfig) : cursorXSpring,
      y: hoverText ? useSpring(useMotionValue(cursorY.get() - 24), springConfig) : cursorYSpring,
      backgroundColor: hoverText ? "var(--color-brand-green)" : "transparent",
      backdropFilter: hoverText ? "none" : "blur(4px)",
      border: hoverText ? "none" : "1px solid rgba(27,142,75,0.8)",
      opacity: isVisible ? 1 : 0,
